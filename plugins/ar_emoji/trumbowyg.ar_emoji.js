...
(function ($) {
    ...
    $.extend(true, $.trumbowyg, {
        langs: {
            ...
            en: {
                ar_emoji: 'Add an emoji'
            },
            da: {
                ar_emoji: 'Tilføj et humørikon'
            },
            de: {
                ar_emoji: 'Emoticon einfügen'
            },
            fr: {
                ar_emoji: 'Ajouter un emoji'
            },
            zh_cn: {
                ar_emoji: '添加表情'
            },
            ru: {
                ar_emoji: 'Вставить emoji'
            },
            ja: {
                ar_emoji: '絵文字の挿入'
            },
        ...
        plugins: {
            ar_emoji: {
                init: function (trumbowyg) {
                    trumbowyg.o.plugins.ar_emoji = $.extend(true, {},
                      defaultOptions,
                      trumbowyg.o.plugins.ar_emoji || {}
                    );

                    trumbowyg.addBtnDef('ar_emoji', buildButtonDef(trumbowyg));
                }
            }
        }
    });
        ...
        return {
            ...
            alterDropdown: function ($dropdown) {
                var prefix = trumbowyg.o.prefix,
                    options = trumbowyg.o.plugins.ar_emoji,
    ...
    function buildDropdown(trumbowyg) {
        ...
        $.each(trumbowyg.o.plugins.ar_emoji.emojiList, function (i, emoji) {
